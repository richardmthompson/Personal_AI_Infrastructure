...
The system loads global context via `${PAI_DIR}/skills/CORE/SKILL.md` on every user prompt through the hook system:

**skills/CORE/SKILL.md contains:**
...
1. **Global Context Load**: Always loads `${PAI_DIR}/skills/CORE/SKILL.md`
...
load_global_context "${PAI_DIR}/skills/CORE/SKILL.md"
...
skills/
  ├── CORE/
  │   └── SKILL.md                # Global context (always loaded)
  ├── website/
...
**Key Changes:**
1. **Global context**: `context/CLAUDE.md` → `skills/CORE/SKILL.md`
2. **Project context**: `context/projects/*` → `skills/*`
3. **Agent context**: Moved to `agents/*.md` with skills/CORE/SKILL.md reference
